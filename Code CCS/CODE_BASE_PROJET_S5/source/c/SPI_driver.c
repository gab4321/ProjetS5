...
void SPI_init(void)
{
    ...
    // configure le MCBSP avec la configuration ci-haut
    MCBSP_config(DSK6713_AIC23_CONTROLHANDLE, &MCBSP0_SPI_Cfg);

    // dirige le MCBSP0 offboard a laide du CPLD
    ...
    {
        // envoie la trame de configuration au MAX3111E
    ...
    //setter linterrupt pour le GPIO 4
    IRQ_setVecs(vectors);
